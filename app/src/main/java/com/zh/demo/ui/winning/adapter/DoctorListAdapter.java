 ...
 * ———— desc :
 */
public class DoctorListAdapter extends BaseQuickAdapter<CommonItem, BaseViewHolder> {

    public DoctorListAdapter(@Nullable List<CommonItem> data) {
        super(R.layout.winning_doctor_item, data);
    }
